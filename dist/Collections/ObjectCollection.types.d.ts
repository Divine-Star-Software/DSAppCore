...
export type ObjectCollectionDataTypes = "string" | "number" | "vec3" | "boolean" | "json";
...
export type CollectionEditType = {
    id: string;
    getElements: (data: ObjectCollectionData, editor: CollectionEditor) => FormBuilderElements<Record<string, any>> | false;
};
export {};
