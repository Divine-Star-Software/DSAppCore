...
import { AddAttributes, AddClass, AddEvents, Component, element, UseCascade, } from "elmtree";
...
export function ContentMenuElement() {
    return element("div", [
        AddAttributes({
            //@ts-ignore
            style: {
        ...
        cascade.addToElment((elm) => {
            ...
            elm.setAttribute("style", `display:block; left:${left}px; top:${top}px;${ContextMenu.style ? ContextMenu.style : ""}`);
        }),
    ], [component]);
}
